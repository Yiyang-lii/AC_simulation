...
#set environment
envir = Environment(room_size=[0,room_length,0,room_length],heat_hole_width=room_length*heat_hole_width_scale,AC_power_scale=AC_power_scale)

particles=Particles(particles_number)
particles.set_particles(pos_type='uniform',vel_type='Boltzmann',room_size=envir.room_size,T=room_temperature,particles_radius=5,molecular_weight=28.9)
