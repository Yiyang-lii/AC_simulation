...
DataProcesser.plot_velocity_distribution(particles.count_average_T(), particles.mass, particles.vel) 
...
DataProcesser.plot_velocity_distribution(particles.count_average_T(), particles.mass, particles.vel)  
print('t00100_average temperature=',particles.count_average_T())
particles=DataProcesser.data_input(f'{filepaths}/{filename}_t01000.bin')   
DataProcesser.plot_velocity_distribution(particles.count_average_T(), particles.mass, particles.vel)  
print('t00372_average temperature=',particles.count_average_T())
